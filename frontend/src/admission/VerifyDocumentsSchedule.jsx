...
const VerifyDocumentsSchedule = () => {
  ...
  useEffect(() => {
    axios.get(`${API_BASE_URL}/active_school_year`).then((res) => {
  ...
  const handleSaveSchedule = async (e) => {
    ...
    try {
      await axios.post(
        `${API_BASE_URL}/create_verify_document_schedule`,
        {
          schedule_date: day,
      ...
      >
        ...
        <DialogContent>
          <Typography>
            ...
            <b>{scheduleToDelete?.building_description || "N/A"}</b> on{" "}
            <b>{formatDate(scheduleToDelete?.schedule_date)}</b>?
          </Typography>
        </DialogContent>
